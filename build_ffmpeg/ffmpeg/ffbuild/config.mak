...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-doc --sysroot=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/sysroot --cross-prefix=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi- --prefix=/Users/tianzuoyu/code/github/build_script/ffmpeg_armeabi-v7a_out --enable-cross-compile --arch=arm --target-os=android --disable-debug --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-shared --enable-static --enable-gpl --enable-libx264 --enable-version3 --disable-avdevice --disable-postproc --enable-jni --enable-mediacodec --enable-decoder=h264_mediacodec --enable-small --enable-nonfree --enable-openssl --extra-ldflags='-march=armv7-a -Wl,--fix-cortex-a8 -lcrypto -lssl -lx264 -lm -ldl' --extra-cflags='-march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fPIC -O3 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG ' --enable-pic
...
INTRINSICS=none
EXTERN_PREFIX=
CC=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi-clang
CXX=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi-g++
AS=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi-clang
OBJCC=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi-clang
LD=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi-clang
DEPCC=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi-clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi-clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
AR_CMD=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi-ar
NM_CMD=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi-nm -g
RANLIB=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi-ranlib -D
STRIP=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi-strip
STRIPTYPE=direct
NVCC=clang
CP=cp -p
LN_S=ln -s -f
CPPFLAGS=-march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fPIC -O3 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG  -fexceptions --sysroot=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/sysroot -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=-march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fPIC -O3 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG   -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fPIC -O3 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -march=armv7-a -std=c11 -fPIE -fomit-frame-pointer -fPIC -marm -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Oz -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=-march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fPIC -O3 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG  -fexceptions  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fPIC -O3 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -march=armv7-a -fPIC -Qunused-arguments
...
LD_PATH=-L
DLLTOOL=
WINDRES=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi-windres
DEPWINDRES=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/bin/arm-linux-androideabi-clang
DOXYGEN=doxygen
LDFLAGS=-march=armv7-a -Wl,--fix-cortex-a8 -lcrypto -lssl -lx264 -lm -ldl -march=armv7-a -Wl,--fix-cortex-a8 -lcrypto -lssl -lx264 -lm -ldl  --sysroot=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_armeabi-v7a/sysroot -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample -Qunused-arguments
LDEXEFLAGS= -fPIE -pie
LDSOFLAGS=

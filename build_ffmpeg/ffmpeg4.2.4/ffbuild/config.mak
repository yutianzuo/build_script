...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-doc --sysroot=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/sysroot --cross-prefix=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android- --prefix=/Users/tianzuoyu/code/github/build_script/ffmpeg_arm64-v8a_out --enable-cross-compile --arch=aarch64 --target-os=android --disable-debug --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-shared --enable-static --enable-gpl --enable-version3 --disable-avdevice --disable-postproc --enable-libx264 --enable-jni --enable-mediacodec --enable-decoder=h264_mediacodec --enable-small --enable-nonfree --enable-openssl --extra-ldflags= --extra-cflags=' -fPIC -O3 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG'
prefix=/Users/tianzuoyu/code/github/build_script/ffmpeg_arm64-v8a_out
...
INTRINSICS=neon
EXTERN_PREFIX=
CC=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android-clang
CXX=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android-g++
AS=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android-clang
OBJCC=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android-clang
LD=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android-clang
DEPCC=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android-clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android-clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android-ar
ARFLAGS=rcD
AR_O=$@
AR_CMD=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android-ar
NM_CMD=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android-nm -g
RANLIB=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android-ranlib -D
STRIP=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android-strip
STRIPTYPE=direct
NVCC=clang
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -fPIC -O3 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -fexceptions --sysroot=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/sysroot -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS= -fPIC -O3 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG  -fPIC -O3 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -std=c11 -fPIE -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Oz -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS= -fPIC -O3 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -fexceptions  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -fPIC -O3 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -fPIC -Qunused-arguments
...
LD_PATH=-L
DLLTOOL=
WINDRES=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android-windres
DEPWINDRES=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/bin/aarch64-linux-android-clang
DOXYGEN=doxygen
LDFLAGS=   --sysroot=/Users/tianzuoyu/code/github/build_script/ffmpeg_toolchain_arm64-v8a/sysroot -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample -Qunused-arguments
LDEXEFLAGS= -fPIE -pie
LDSOFLAGS=
